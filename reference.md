...
| [scoring-trap-2024](/properties/counters/scoring-trap-2024.md) | The scoring-trap-2024 counter represents the number of game elements scored in a trap during the teleop/endgame period of the match. | This property stores an integer value of the number of game elements scored in a trap during the teleop/endgame period. |
