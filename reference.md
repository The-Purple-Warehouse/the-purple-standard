...
| [spotlight-2024](/properties/abilities/spotlight-2024.md) | The spotlight ability represents whether the robot can pick up game pieces from the ground. | This property stores a boolean (true/false) value depending on whether or not the robot was spotlit (High Note scored on their microphone by human player) during the final 20 seconds of the match.<br><ul><li>true - the robot was spotlit</li><li>false - the robot was not spotlit</li></ul> |
