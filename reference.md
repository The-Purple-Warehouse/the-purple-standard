...
| [defense](/properties/abilities/defense.md) | The defense ability represents whether the robot played defensively at any point in the match for any amount of time. | This property stores a boolean (true/false) value depending on whether or not the robot played defensively at any point in the match.<br><ul><li>true - the robot played defense</li><li>false - the robot never played defense</li></ul> |
...
| [teleop-stage-level-2024](/properties/abilities/teleop-stage-level-2024.md) | The teleop-stage-level-2024 ability represents the level of stage climb of the robot at the end of the teleoperated period of the match. | This property stores an integer (0 - 3) based on the level of stage climb.<br><ul><li>3: onstage in harmony</li><li>2: onstage</li><li>1: parked</li><li>0: none</li></ul> |
